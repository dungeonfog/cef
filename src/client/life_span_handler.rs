...
//         window_info: WindowInfo, //*mut _cef_window_info_t,
//         client: &mut Client, // *mut *mut _cef_client_t,
//         settings: BrowserSettings, // *mut _cef_browser_settings_t,
//         extra_info: &mut ValueDictionary, // *mut *mut _cef_dictionary_value_t,
...
//     fn on_after_created(self_: *mut _cef_life_span_handler_t, browser: *mut _cef_browser_t) {
...
//     /// browsers
//     ///     exist.
//     fn do_close(self_: *mut _cef_life_span_handler_t, browser: *mut _cef_browser_t) -> c_int {
...
//     fn on_before_close(self_: *mut _cef_life_span_handler_t, browser: *mut _cef_browser_t)
// }

// pub struct LifeSpanHandlerWrapper;

// cef_callback_impl!{
//     impl LifeSpanHandlerWrapper: cef_life_span_handler_t {
//         fn on_before_popup(
//             &mut self: *mut _cef_life_span_handler_t,
