...
pub trait RequestHandler<C> where C: Client + Sync + Send {
    ...
    /// if any.
    fn get_resource_request_handler(&self, browser: &Browser<C>, frame: &Frame<C>, request: &Request, is_navigation: bool, is_download: bool, request_initiator: &str, disable_default_handling: &mut bool) -> Option<Box<dyn ResourceRequestHandler>> { None }
