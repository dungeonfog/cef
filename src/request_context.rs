...
pub enum PluginPolicy {
    ...
    DetectImportant = cef_plugin_policy_t::PLUGIN_POLICY_DETECT_IMPORTANT,
    Block = cef_plugin_policy_t::PLUGIN_POLICY_BLOCK,
    Disable = cef_plugin_policy_t::PLUGIN_POLICY_DISABLE,
}
