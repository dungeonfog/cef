...
pub trait RenderProcessHandler: Send + Sync {
    ...
    fn on_render_thread_created(&self, extra_info: &HashMap<String, String>) {}
    ...
    fn on_browser_created(&self, browser: &mut Browser, extra_info: &HashMap<String, String>) {}
    /// Called before a browser is destroyed.
    fn on_browser_destroyed(&self, browser: &mut Browser) {}
    /// Return the handler for browser load status events.
    fn get_load_handler(&self) -> impl LoadHandler;
}
